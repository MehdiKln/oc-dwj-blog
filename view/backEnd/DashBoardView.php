            ...
            <div class="col-10">
                  <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active admin_home" id="v-pills-home" role="tabpanel"
                              ...
                              <div class="mt-4 ml-3">
                        	<p>Nombre de posts : <?php echo $countPost; ?></p>
                              <p>Nombre d'utilisateurs : <?php echo $countUser; ?></p> <br>
                              ...
                              <div id="formbg">
                                    <form method="post" action="index.php?action=submitPost">
                                          <p> <label for="title" id="posttitle"> Titre : </label><br>
                                                <input type="text" name="title" id="title" placeholder="Titre de votre post"
